                            ...
                            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 14, flexGrow: 0 }}>
                                {farms.map(farm => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <Ionicons name="location-outline" size={14} color={selected ? '#fff' : '#4D5B50'} />
...
const styles = StyleSheet.create({
    ...
    centered: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F6F8F1' },
    farmChip: {
        flexDirection: 'row',
        alignItems: 'center',
        height: 36,
    ...
    farmChipText: { color: '#4D5B50', fontWeight: '700', fontSize: 13 },
    ...
    sectionTitle: { color: '#102418', fontSize: 18, fontWeight: '800' },
    sectionSubtitle: { color: '#66736B', fontSize: 13, fontWeight: '600', marginTop: 4, lineHeight: 18 },
    ...
    choiceText: { fontSize: 13, fontWeight: '700', color: '#4D5B50' },
    ...
    emptyText: { color: '#66736B', fontSize: 14, fontWeight: '600', textAlign: 'center', marginTop: 12, lineHeight: 20 },
    unavailablePanel: {
    ...
    footnote: { color: '#66736B', fontSize: 12, fontWeight: '600', textAlign: 'center', marginTop: 8 },
    fab: {
        position: 'absolute',
        bottom: 28,
        right: 20,
